...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $koneksi->prepare("INSERT INTO pengeluaran_harian (tanggal, deskripsi, jumlah) VALUES (?, ?, ?)");
    $stmt->bind_param("ssi", $tanggal, $deskripsi, $jumlah);
    $stmt->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Tambah Pengeluaran Harian</title>
</head>
<body>
 <aside>
    <nav>  
  ...
  <main>
    ...
    <form method="post">
        ...
        <label>Deskripsi: <input type="text" name="deskripsi" required></label><br><br>
        <label>Jumlah: <input type="number" name="jumlah" required></label><br><br>
