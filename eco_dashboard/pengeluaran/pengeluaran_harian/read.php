...
$result = $koneksi->query("SELECT * FROM pengeluaran_harian ORDER BY tanggal DESC");
?>
...
<body>
 ...
 <aside>
    ...
    <h2>Daftar Pengeluaran Harian</h2>
    <div class="main-hyperlink">
        <a class="add-btn" href="create.php">Tambah</a>
    ...
    <table>
        ...
        <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
                ...
                <td>
                    <div class="secondary-hyperlink"></div>
